...
function Result({ result, navigate }) {
  ...
  const SongRow = ({ song, index, emotion }) => {
    ...
    return (
      <div className="song-row">
        ...
        >
          ...
          {song.spotifyUrl && (
            <div
              style={{ color: "#1DB954", fontSize: 16, cursor: "pointer" }}
      ...
      <div className="result-screen">
        ...
        <div className="emotion-hero">
          ...
          <div style={{ flex: 1 }}>
            ...
            <div className="emotion-conf-text">
              {current.percentage}% of the time
            </div>
